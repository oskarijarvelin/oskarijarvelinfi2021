                ...
                <Navbar expand="lg">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav" className="justify-content-end">
                        <Nav className="ml-auto">
                            ...
                            <Navlink href="/cv"><Nav.Link href="/cv" className="fw-bolder px-lg-3">CV</Nav.Link></Navlink>

                            <NavDropdown title="Osaaminen" className="fw-bolder px-lg-2" id="basic-nav-dropdown">
                            ...
                            <Nav.Link href="https://www.linkedin.com/in/oskarijarvelin/" target="_blank" rel="nofollow">
